  ...
  <div class="card-body">
    <div class="col-lg-6">
      <div class="d-flex align-items-center flex-wrap py-25 px-5">
        <h1 class="text-dark font-weight-bolder mr-12">404</h1>
        <div class="h4 text-dark-50">There may be a misspelling in the URL entered, or the page you are looking for may no longer exist.</div>
      </div>
    </div>
  </div>
</div>
