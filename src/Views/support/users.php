      ...
      <div class="dropdown dropdown-inline mr-2" data-toggle="tooltip" title="" data-original-title="Export" data-theme="dark">
        ...
        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
          <ul class="navi flex-column navi-hover py-2">
            ...
            <li class="navi-item">
              <a href="<?= site_url('support/print/attendances'); ?>" class="navi-link">
            ...
            <li class="navi-item">
              <a href="<?= site_url('support/export/excel/attendances'); ?>" class="navi-link">
                <span class="navi-icon">
            ...
            <li class="navi-item">
              <a href="<?= site_url('support/export/pdf/attendances'); ?>" class="navi-link">
                <span class="navi-icon">
